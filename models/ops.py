...
class Operations:
    ...
    def tf_add(self, inpt, pinpt=None):
    ...
    def tf_multiply(self ,inpt, pinpt=None):
    ...
    def tf_stall(self, inpt, pinpt=None):
        pad_res = tf.pad(inpt, [[0,0],[0,self.num_features - 1]], "CONSTANT", name="tf_mult_pad")
        return  inpt
    
    #get input lenght, asssing all values to ones and then reduce
    def tf_inpt_len(self,inpt, pinpt=None):
    ...
    def tf_divide(self, inpt, pinpt=None):
    ...
    def tf_save_inpt(self,inpt, pinpt=None):
        
        return  inpt
        
    #get value from saved store 
    def tf_input_pinput_concat(self,inpt):
        return  inpt
    
    ######helper functions######
    def not_zero(self, inpt, pinpt):
